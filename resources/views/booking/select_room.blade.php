                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><span>Guests: </span>
                                                            <span class="booking-guests-wrapper">
                                                                <span>Adult: {{ session()->get('booking.adult') }} <span>,</span>
                                                                </span>
                                                            </span>
                                                            <span class="booking-guests-wrapper">
                                                                <span>Child: {{ session()->get('booking.child') }}<span></span>
                                                                </span>
                                                            </span>
                                                        </li>
                            ...
                            <div class="booking-main-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-7">
                                        ...
                                        <form name="book" method="POST" action="{{ route('post.selected_room') }}">
                                            @csrf
                                            ...
                                            <input type="hidden" value="{{ $item->id }}" name="room-id" />
                                            <input type="hidden" value="{{ $item->price }}" name="room-price" />
                                            <input type="hidden" value="{{ $item->category_name }}" name="room-name" />
