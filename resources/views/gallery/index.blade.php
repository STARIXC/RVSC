...
<div class="content">
    ...
    <!-- Page Content -->
    <section id="team" class="pb-5 pt-5 mt-5">


        <div class="container">
            <div class="row">
                <div class="gallery col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h1 class="gallery-title">RVSC Photo Gallery</h1>
                </div>
                <div align="center">
                    <button class="btn btn-primary active filter-button" data-filter="all">ALL</button>
                    <button class="btn btn-primary filter-button" data-filter="gallery">Gallery</button>
                    <button class="btn btn-primary filter-button" data-filter="events">Events</button>
                    ...
                    <div class="row">
                        ...
                        <div class="modal fade mt-10" id="image-gallery" tabindex="0" role="dialog"
