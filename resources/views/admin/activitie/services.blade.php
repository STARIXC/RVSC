                ...
                <div class="dropdown d-inline-block widget-dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-recent-order1">
                    <li class="dropdown-item">
                      <a href="{{ url('services/edit/'.$item->id) }}">Edit</a>
                    </li>
                    <li class="dropdown-item">
                      <a href="{{ url('softdelete/service/'.$item->id )}}">Remove</a>
                    </li>
                  </ul>
                </div>
              </td>
            ...
            <tr>
              ...
              <td class="text-right">
                <div class="dropdown d-inline-block widget-dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-recent-order1">
                    <li class="dropdown-item">
                      <a href="{{ url('service/restore/'.$item->id) }}">Restore</a>
                    </li>
                    <li class="dropdown-item">
                      <a href="{{ url('service/delete/'.$item->id )}}">Delete</a>
                    </li>
                  </ul>
                </div>
              </td>
