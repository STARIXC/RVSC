                    ...
                    <div class="dropdown d-inline-block widget-dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-recent-order1">
                        <li class="dropdown-item">
                          <a href="{{ url('site_image/edit/'.$item->id) }}">Edit</a>
                        </li>
                        <li class="dropdown-item">
                          <a href="{{ url('softdelete/site_image/'.$item->id )}}">Remove</a>
                        </li>
                      </ul>
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <div class="dropdown d-inline-block widget-dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-recent-order1">
                        <li class="dropdown-item">
                          <a href="{{ url('media/restore/'.$item->id) }}">Restore</a>
                        </li>
                        <li class="dropdown-item">
                          <a href="{{ url('media/delete/'.$item->id )}}">P Delete</a>
                        </li>
                      </ul>
                    </div>
                  </td>
            ...
            <div class="form-body">
              ...
              <form method="post" action="{{ route('store.media') }} " enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <label class="checkbox-inline">
                    <input type="checkbox" id="inlineCheckbox2" name="gallerypage" value="yes"> Site Gallery
                  </label>
                  <label class="checkbox-inline">
                    <input type="checkbox" id="inlineCheckbox3" name="eventspage" value="yes"> Events Gallery
                  </label>
                </div>
                <div class="form-group"> <label for="exampleInputEmail1">Image Description</label> <input type="text"
                    class="form-control" name="description" value="" required='true'> </div>
