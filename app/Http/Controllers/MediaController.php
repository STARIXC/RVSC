...
class MediaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $image_location='backend/assets/images/site_content/';
         ...
         if (empty($request->gallerypage)) {
            $dataimage['gallery']='No';
         }else{
            $dataimage['gallery']=$request->gallerypage;
         }
         ...
         if (empty($request->events_page)) {
            $dataimage['gallery']='No';
         }else{
            $dataimage['events_page']=$request->eventspage;
         }
    ...
    public function storeMultiple(Request $request)
    {
        ...
        foreach ($images as $img) {
            $make_name = hexdec(uniqid()).'.'.$img->getClientOriginalExtension();
          Image::make($img)->resize(1280,720)->save('backend/assets/images/site_content/'.$make_name);
